...
JComboBox comboBox = new JComboBox(DBInfo.getValue("sports"));
		
		JComboBox comboBox_1 = new JComboBox(DBInfo.getValue("batchtime"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    if(i!=0)
				{
					...
					new ViewUserProfile(adminmail,usermail).setVisible(true);
					dispose();
				}
				if(i==0)
				{
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(textField_6, GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
								.addComponent(textField_5, GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
								.addComponent(textField_2, GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
