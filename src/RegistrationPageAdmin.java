...
public class RegistrationPageAdmin extends JFrame {
	...
	public RegistrationPageAdmin(String cngmail) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
	 ...
	 comboBox_1_1 = new JComboBox();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String s11="admin";
				int i=0;
				if(s1.length()==0||s2.length()==0||s3.length()==0||s8.equalsIgnoreCase("Select")||s6.length()==0||s7.length()==0||s9.length()==0||s10.length()==0)
				{
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new Admin(cngmail).setVisible(true);
				dispose();
			}
		});
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel_9)
						.addComponent(btnNewButton_3, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE))
					.addGap(33)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
